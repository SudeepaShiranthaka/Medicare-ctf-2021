			...
			<div class="container-fluid">
                ...
                <div class="row">
        			<div class="col-xl-8 col-sm-3">
				        <div class="card">
					        <div class="card-body">
                                <form method="POST" action="data-conf.php">
                                    <div class="form-group">
                                        <label class="mb-1 text-black"><strong>Conf. Title</strong></label>
                                            <input type="text" 
                                                name="ConfTitle"
                                                class="form-control" 
                                    ...
                                    <div class="form-group">
                                        <label class="mb-1 text-black"><strong>Resource</strong></label>
                                            <input type="text" 
                                                name="resource"
                                                class="form-control" 
                                    ...
                                    <div class="form-group">
                                        <label class="mb-1 text-black"><strong>Date</strong></label>
                                            <input type="text" 
                                                name="date"
                                                class="form-control" 
                                    ...
                                    <div class="text-center mt-4">
                                        <a href="userclick_details.php">
                                            <button
                                                ...
                                                name="newjob"
                                                >
                                                <b><xyz style="font-size:20px">Add</xyz></b>
                                            </button>
                                        </a>
                                    </div>
                                </form>
