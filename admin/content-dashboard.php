					...
					<div class="col-xl-3  col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="fs-34 text-black font-w600">167</h2>
					...
					<div class="col-xl-3  col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="fs-34 text-black font-w600">$8,034</h2>
									...
									<div class="card-body">
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<div>
													<h4 class="mb-sm-2 mb-1"><a href="doctor.html" 
                                                    class="text-black">Dr. Amal Jayantha</a></h4>
													<span class="fs-14 text-primary font-w600">Neurologists</span>
												</div>
											</div>
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<div>
													<h4 class="mb-sm-2 mb-1"><a href="doctor.html" 
                                                    class="text-black">Dr. Namal Rathnayake</a></h4>
													<span class="fs-14 text-primary font-w600">Psychiatrists</span>
												</div>
											</div>
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
												<ul>
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<div>
													<h4 class="mb-sm-2 mb-1"><a href="doctor.html" 
                                                    class="text-black">Dr. Kasuni Solochana</a></h4>
													<span class="fs-14 text-primary font-w600">Neurologists</span>
												</div>
											</div>
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<div>
													<h4 class="mb-sm-2 mb-1"><a href="doctor.html" 
                                                    class="text-black">Dr. Sitharu Perera</a></h4>
													<span class="fs-14 text-primary font-w600">Obstetricians and gynecologists</span>
												</div>
											</div>
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
												<ul>
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<div>
													<h4 class="mb-sm-2 mb-1"><a href="doctor.html" 
                                                    class="text-black">Dr. Ravindu Madagedara</a></h4>
													<span class="fs-14 text-primary font-w600">Anesthesiologists</span>
												</div>
											</div>
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
												<ul>
										...
										<div class="d-sm-flex pb-0 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<div>
													<h4 class="mb-sm-2 mb-1"><a href="doctor.html" 
                                                    class="text-black">Dr. Bilal Reza</a></h4>
													<span class="fs-14 text-primary font-w600">Psychiatrists</span>
												</div>
											</div>
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
